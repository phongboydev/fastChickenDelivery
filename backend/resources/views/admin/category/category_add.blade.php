                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="quickForm" action="{{ URL::to(route('admin.category.store')) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="image_category" accept="image/*" class="custom-file-input required"
                                                    id="customFile">
