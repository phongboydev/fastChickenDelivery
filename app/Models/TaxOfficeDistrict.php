...
class TaxOfficeDistrict extends Model
{
    use HasFactory, HasTranslations;

    protected $table = 'tax_office_districts';
    ...
    protected $fillable = [
        'tax_office_province_id', 'administrative_division_code', 'tax_office_code', 'tax_office', 'administrative_division',
        'tax_office_active', 'administrative_division_active', 'is_administrative_division'
    ];
    ...
    public function taxOfficeWard()
    {
        return $this->hasMany(TaxOfficeWard::class);
    }
}
