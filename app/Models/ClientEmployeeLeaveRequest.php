 ...
 */
class ClientEmployeeLeaveRequest extends Model
{
    ...
    protected $table = 'client_employee_leave_requests';
     ...
     * @var array
     */
    protected $fillable = ['client_employee_id', 'approved_by', 'start_time', 'end_time', 'duration', 'half_day', 'type_of_leave', 'reason', 'status', 'approved_date', 'approved_comment', 'deleted_at', 'created_at', 'updated_at'];
        ...
        if (!$user->isInternalUser()) {
            ...
            switch ($role) {
                ...
                case Constant::ROLE_CLIENT_STAFF:
                    ...
                    logger("ClientEmployeeLeaveRequest::scopeAuthUserAccessible Customer query");
                    logger($query->toSql());
                    return $query;
            }
        } else {
