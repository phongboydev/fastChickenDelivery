...
class ClientEmployeeCreateNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return $this->getMailMessage($subject, 'CLIENT_EMPLOYEE_CREATED', $predefinedConfig, 'emails.employeeCreated');
    }
